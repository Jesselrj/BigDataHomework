...
![POJ-104 retrieval metrics](outputs/figures/fig1_main_results_cvpr.png)
...
![Semantic retrieval framework](outputs/figures/fig2_method_framework_cvpr.png)
...
![SupCon CE repaired case](outputs/figures/fig3_error_repair_cvpr.png)

上述插图由 Python/matplotlib 生成，PDF 版本也保存在 `outputs/figures/`，可直接用于报告或幻灯片。如需重新生成：
