...
| 方法 | 说明 | 任务 | MAP@R | Recall@1 | Recall@5 | Recall@10 | MRR | F1 |
|---|---|---|---:|---:|---:|---:|---:|---:|
| TF-IDF | 对比方法 | 检索 | 0.5388 | 0.8077 | 0.9140 | 0.9487 | 0.8561 | - |
| CodeBERT | 对比方法 | 分类 | - | - | - | - | - | 0.9117 |
| GraphCodeBERT | 对比方法 | 分类 | - | - | - | - | - | 0.9170 |
| UniXcoder | 对比方法 | 检索 | 0.9811 | 0.9977 | 0.9988 | 0.9992 | 0.9982 | - |
