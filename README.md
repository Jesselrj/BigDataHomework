...
仓库提供了独立的 SVG 插图，适合直接放入课程报告、答辩 PPT 或论文式实验分析中：

![Retrieval metrics](outputs/figures/fig1_retrieval_metrics.svg)

![Metric matrix](outputs/figures/fig2_metric_matrix.svg)

![MAP@R improvement](outputs/figures/fig3_mapr_improvement.svg)

![Method framework](outputs/figures/fig4_method_framework.svg)

![Repaired retrieval case](outputs/figures/fig5_repaired_case.svg)
